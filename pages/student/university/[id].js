// pages/student/university/[id].js
  ...
  return (
    <AdminLayout title={uni.name}>
      <div className="max-w-full">
        <button onClick={()=>router.push('/student/universities')} className="flex items-center gap-2 text-sm text-slate-500 hover:text-brand-600 mb-4 transition-colors">
