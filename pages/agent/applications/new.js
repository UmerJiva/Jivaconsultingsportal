// pages/agent/applications/new.js — Full application creation form page
                  ...
                  <div>
                    ...
                    {eligibility.status === 'already_applied' && (
                      <div className="flex items-center justify-between bg-red-50 border border-red-200 rounded-xl px-5 py-4">
                        ...
                        <button onClick={()=>router.push('/agent/applications')} className="text-sm font-bold text-red-600 border border-red-200 rounded-xl px-3 py-1.5 hover:bg-red-100 transition-colors whitespace-nowrap ml-3">
                          View application
                        </button>
                      </div>
                    )}
                    ...
                    {eligibility.status === 'not_eligible' && (
                      <div className="bg-red-50 border border-red-200 rounded-xl p-5">
                        <div className="flex items-start justify-between gap-3">
                          ...
                          <button onClick={()=>router.push(`/agent/student/${selectedStudent?.id}`)} className="text-sm font-bold text-red-600 border border-red-200 rounded-xl px-3 py-1.5 hover:bg-red-100 transition-colors whitespace-nowrap shrink-0">
                            Update Profile
                          </button>
                        </div>
                      </div>
